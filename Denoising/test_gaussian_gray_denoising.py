...
parser = argparse.ArgumentParser(description='Gasussian Grayscale Denoising using ASTSFormer')
...
if args.model_type == 'blind':
    yaml_file = 'Options/GaussianGrayDenoising_ASTSFormer.yml'
else:
    yaml_file = f'Options/GaussianGrayDenoising_ASTSFormerSigma{args.sigmas}.yml'
import yaml
