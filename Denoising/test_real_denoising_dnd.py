...
parser.add_argument('--result_dir', default='./results/Real_Denoising/DND_SSSA/', type=str, help='Directory for results')
...
####### Load yaml #######
yaml_file = 'Options/RealDenoising_ASTSFormer_SSSA.yml'
import yaml
