...
parser = argparse.ArgumentParser(description='Gasussian Color Denoising using ASTSFormer')
...
for dataset in datasets:
    ...
    for sigma_test in sigmas:
        file_path = os.path.join('results', 'Gaussian_Color_Denoising_sssa', args.model_type, dataset, str(sigma_test))
