...
from basicsr.models.archs.ASTSFormer_arch import ASTSFormer
...
parser = argparse.ArgumentParser(description='Gaussian Color Denoising using ASTSFormer')

parser.add_argument('--input_dir', default='./Datasets/test/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/Gaussian_Color_Denoising_sssa/', type=str, help='Directory for results')
...
if args.model_type == 'blind':
    yaml_file = 'Options/GaussianColorDenoising_ASTSFormer.yml'
else:
    yaml_file = f'Options/GaussianColorDenoising_ASTSFormerSigma{args.sigmas}_SSSA.yml'
import yaml
