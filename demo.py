...
##--------------------------------------------------------------
##------- Demo file to test ASTSFormer on your own images---------
...
parser = argparse.ArgumentParser(description='Test ASTSFormer on your own images')
...
def get_weights_and_parameters(task, parameters):
    if task == 'Motion_Deblurring':
        ...
        weights = os.path.join('experiments', 'RealDenoising_ASTSFormer', 'models','net_g_300000.pth')
...
load_arch = run_path(os.path.join('basicsr', 'models', 'archs', 'ASTSFormer_arch.py'))
model = load_arch['ASTSFormer'](**parameters)
